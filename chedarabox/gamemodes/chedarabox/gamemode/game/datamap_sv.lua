...
concommand.Add("pointreset", function(ply,cmd,args)
if not ply:IsAdmin() then return end
	if args[1] ~= "" then
		for name,info in pairs(SpawnPointsList) do
...
concommand.Add("pointsync", function(ply,cmd,args)
if not ply:IsAdmin() then return end
	SendSpawnPoint()
end)

concommand.Add("pointpage", function(ply,cmd,args)
if not ply:IsAdmin() then return end
...
concommand.Add("pointpages", function(ply,cmd,args)
if not ply:IsAdmin() then return end
	PrintMessage(3,GetMaxDataPages("spawnpointst"))
end)

concommand.Add("points", function(ply,cmd,args)
if not ply:IsAdmin() then return end
