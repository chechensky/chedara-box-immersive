...
CLASS.weapons = {"tourniquet","weapon_police_bat","med_band_big","medkit","painkiller","adrenaline","weapon_handcuffs","weapon_taser","weapon_hg_flashbang"}
CLASS.main_weapon = {"weapon_sib_m4a1","weapon_sib_asval"}
CLASS.secondary_weapon = {"weapon_sib_glock"}
CLASS.models = {"models/player/swat.mdl","models/player/riot.mdl","models/player/urban.mdl","models/player/gasmask.mdl"}
...
function CLASS:On()
	...
	JMod.EZ_Equip_Armor(self,"Level-III",color)
