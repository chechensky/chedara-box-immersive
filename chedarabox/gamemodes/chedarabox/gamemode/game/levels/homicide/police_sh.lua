...
CLASS.weapons = {"tourniquet","med_band_big","medkit","painkiller","weapon_handcuffs","weapon_taser","weapon_hg_flashbang","weapon_police_bat"}
CLASS.secondary_weapon = {"weapon_sib_glock"}
CLASS.models = {"models/player/police.mdl","models/player/police_fem.mdl"}
...
function CLASS:On()
	...
	JMod.EZ_Equip_Armor(self,"Level-IIIA",color)
