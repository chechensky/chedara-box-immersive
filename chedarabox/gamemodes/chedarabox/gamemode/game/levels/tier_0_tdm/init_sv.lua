...
function tdm.PlayerSpawn(ply,teamID)
	...
	ply:ChatPrint("Для закупки оружия напишите в консоль buymenu")
	...
	if math.random(1,3) == 3 then if ply:Team() == 1 then ply:Give("weapon_hg_f1") ply:Give("weapon_hg_type59") else ply:Give("weapon_hg_f1") ply:Give("weapon_hg_rgd5") end end

	JMod.EZ_Equip_Armor(ply,"ACH-Helmet")
	local r = math.random(1,2)
	JMod.EZ_Equip_Armor(ply,(r == 1 and "Level-III") or (r == 2 and "Level-IIIA"))
end
