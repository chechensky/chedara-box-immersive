...
weaponscommon = {
"item_food_water","item_food_pepsicola","item_food_meatstake","item_food_sandwick","adrenaline","item_food_burger","item_food_bigburger","weapon_sogknife","weapon_knife","med_band_small","medkit","med_band_big","tourniquet","tire"
}

weaponsuncommon = {
"medkit","weapon_molotok","painkiller","weapon_trap","antidot"
}

weaponsrare = {
"weapon_sib_glock","weapon_sib_mr8013t","weapon_gurkha","weapon_t","*ammo*"
}
...
hook.Add("PropBreak","homigrad",function(att,ent)
	...
	if type1 then
		sound.Play(huy,sndsDrop[type1],50,0.5)
	end
end)
