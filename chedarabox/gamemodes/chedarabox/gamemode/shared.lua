...
GM.Name = "ChedaraBox"
GM.Author = "checha+Mannytko+quezkaly"
GM.Email = "N/A"
GM.Website = "N/A"
GM.TeamBased = true
...
local start = SysTime()
print("	start chedarabox gamemode.")

GM.includeDir("chedarabox/gamemode/game/")--все файлы запускает, когда обновляем один.. можно из этого даже чо-то сделать.нахуй

print("	end chedarabox gamemode for " .. math.Round(SysTime() - start,4) .. "s")
