...
hook.Add("Move", "TFALeanThink", function(ply)
	...
	if targ == 0 and ((wep.GetIronSights and wep:GetIronSights()) or (wep.GetIronsights and wep:GetIronsights())) then
...
hook.Add("PlayerPostThink", "rpgdgdfg", function(ply)
if IsValid(ply:GetActiveWeapon()) then
	if ply:GetActiveWeapon():GetClass() == "wep_mann_hmcd_rpg" or ply:GetActiveWeapon():GetClass() == "weapon_rpgg" then
...
hook.Add("PlayerSpawn", "kekmfksldf", function(ply)
