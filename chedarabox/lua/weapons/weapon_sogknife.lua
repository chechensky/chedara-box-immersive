...
SWEP.Instructions = "Knife SOG, made in USA, special for personal group in time War on Vietnam. +changeattack - сменить тип атаки."
SWEP.Category = "Chedara Box - Ближний Бой"

SWEP.Spawnable= true
SWEP.AdminSpawnable= true
SWEP.AdminOnly = false
if(CLIENT)then SWEP.WepSelectIcon=surface.GetTextureID("vgui/wep_jack_hmcd_knife") SWEP.IconOverride="vgui/wep_jack_hmcd_knife" end
SWEP.ViewModelFOV = 60
SWEP.ViewModel = "models/weapons/w_jnife_j.mdl"
