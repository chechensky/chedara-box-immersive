if (CLIENT) then SWEP.WepSelectIcon=surface.GetTextureID("vgui/wep_jack_hmcd_poisonneedle") SWEP.IconOverride="vgui/wep_jack_hmcd_poisonneedle" end
SWEP.Base = "medkit"
...
if SERVER then
    ...
    function SWEP:DrawHUD()
        ...
        surface.SetMaterial(Material("vgui/wep_jack_hmcd_poisonneedle"))
