if (CLIENT) then SWEP.WepSelectIcon=surface.GetTextureID("vgui/wep_jack_hmcd_poisonliquid") SWEP.IconOverride="vgui/wep_jack_hmcd_poisonliquid" end
SWEP.Base = "medkit"
...
if SERVER then
    ...
    function SWEP:DrawHUD()
        ...
        surface.SetMaterial(Material("vgui/wep_jack_hmcd_poisonliquid"))
