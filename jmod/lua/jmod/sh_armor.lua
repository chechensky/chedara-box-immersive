...
JMod.BodyPartHealthMults = {
	...
	tourniquetleftleg = .01,
	tourniquetrightleg = .01,
	tourniquetlefthand = .01,
	tourniquetrighthand = .01
...
JMod.ArmorSlotNiceNames = {
	...
	rightcalf = "Правый голень",
	rightshoulder = "Правое плечо",
	rightforearm = "Правое предплечье",
	leftshoulder = "Левое плечо",
	leftforearm = "Левое предплечье",
	tourniquetleftleg = "Жгут на левой ноге",
	tourniquetrightleg = "Жгут на правой ноге",
	tourniquetlefthand = "Жгут на левой руке",
	tourniquetrighthand = "Жгут на правой руке"
}
...
JMod.ArmorTable = {
	-- medicine
	["RHandTourniquet"] = {
		PrintName = "RHand Tourniquet",
		mdl = "models/tourniquet/tourniquet_put.mdl", -- aegis
		slots = {
			tourniquetrighthand = .1
		},
		...
		wgt = 1,
		dur = 1,
		ent = "ent_jack_gmod_ezarmor_rhandtourniquet"
	},

	["LHandTourniquet"] = {
		PrintName = "LHand Tourniquet",
		mdl = "models/tourniquet/tourniquet_put.mdl", -- aegis
		slots = {
			tourniquetlefthand = .1
		},
		def = NonArmorProtectionProfile,
		...
		wgt = 1,
		dur = 1,
		ent = "ent_jack_gmod_ezarmor_lhandtourniquet"
	},

	["RLegTourniquet"] = {
		PrintName = "RLeg Tourniquet",
		mdl = "models/tourniquet/tourniquet_put.mdl", -- aegis
		slots = {
			tourniquetrightleg = .1
		},
		def = NonArmorProtectionProfile,
		bon = "ValveBiped.Bip01_R_Thigh",
		siz = Vector(1.35, 1.35, 1.35),
		pos = Vector(1, 11, 4),
		ang = Angle(90, 0, 0),
		wgt = 1,
		dur = 1,
		ent = "ent_jack_gmod_ezarmor_rlegtourniquet"
	},

	["LLegTourniquet"] = {
		PrintName = "LLeg Tourniquet",
		mdl = "models/tourniquet/tourniquet_put.mdl", -- aegis
		slots = {
			tourniquetleftleg = .1
		},
		...
		wgt = 1,
		dur = 1,
		ent = "ent_jack_gmod_ezarmor_llegtourniquet"
	},
	...
	["[HMCD] M40"] = {
		PrintName = "[HMCD] M40 Gas Mask",
		Category = "JMod - EZ Homicide",
		mdl = "models/gasmasks/m40.mdl", -- не ебу че это, просто m40 противогаз
		slots = {
			eyes = 1,
			mouthnose = 1
		},
		...
		pos = Vector(1.85, 2.5, -0.4),
		ang = Angle(90, 100, 0),
		wgt = 5,
		mskmat = "materials/overlays/ba_gasmask.png",
		sndlop = "snds_jack_gmod/mask_breathe.wav",
		ent = "ent_jack_gmod_ezarmor_m40gasmask",
		tgl = {
			pos = Vector(0.2, 5.2, -0.5),
			ang = Angle(90, 150, 0),
			eff = {},
			mskmat = "",
			sndlop = "",
	...
	["Welding mask"] = {
		...
		Category = "JMod - EZ Homicide",
		mdl = "models/hl2ep2/welding_helmet.mdl", -- csgo misc
		slots = {
			head = 0.6,
			eyes = .4,
			mouthnose = .4
		...
		ent = "ent_jack_gmod_ezarmor_weldm",
		tgl = {
			pos = Vector(0, 0, 0),
			ang = Angle(170, 180, 90),
			mskmat = "",
	...
	["[HMCD] ArcticBalaclava"] = {
		PrintName = "[HMCD] Arctic Balaclava",
		Category = "JMod - EZ Homicide",
		mdl = "models/balaklava/arctic_balaclava.mdl", -- css
		slots = {
			mouthnose = .8
		},
		def = NonArmorProtectionProfile,
		...
		wgt = 5,
		dur = 10,
		ent = "ent_jack_gmod_ezarmor_arbalacl",
	},
	["[HMCD] PhoenixBalaclava"] = {
		PrintName = "[HMCD] Phoenix Balaclava",
		Category = "JMod - EZ Homicide",
		mdl = "models/balaklava/phoenix_balaclava.mdl", -- css
		slots = {
			mouthnose = .8
		},
		def = NonArmorProtectionProfile,
		...
		wgt = 5,
		dur = 10,
		ent = "ent_jack_gmod_ezarmor_phbalacl",
	},
	["NightVisionGoggles"] = {
	...
	["[HMCD] GPNVG-18"] = {
		PrintName = "[HMCD] GPNVG-18",
		Category = "JMod - EZ Homicide",
		mdl = "models/arctic_nvgs/nvg_gpnvg.mdl", -- scp something
		clr = {
			r = 255,
			g = 255,
			b = 255
	...
	["ACH-Helmet"] = {
		PrintName = "[HMCD] ACH Helmet",
		Category = "JMod - EZ Homicide",
		mdl = "models/barney_helmet.mdl", -- hmcd
		mat = "models/mat_jack_hmcd_armor",
		clr = {
			r = 200,
		    g = 200,
		    b = 200
		...
		bon = "ValveBiped.Bip01_Head1",
		siz = Vector(1, 1, 0.9),
		pos = Vector(1, 0.7, 0.1),
		ang = Angle(-80, 0, -90),
		wgt = 20,
		dur = 160,
		ent = "ent_jack_gmod_ezarmor_achhelmet"
	},
	["Heavy-Helmet"] = {
	...
	["Moto-Helmet"] = {
		PrintName = "[HMCD] Moto-Helmet",
		Category = "JMod - EZ Homicide",
		mdl = "models/dean/gtaiv/helmet.mdl", -- gtaiv
		slots = {
			head = 0.6,
			eyes = .4,
			mouthnose = .4,
		...
		ent = "ent_jack_gmod_ezarmor_motohelm",
	},
	["Riot-Police-Helmet"] = {
		PrintName = "[HMCD] Police-Riot-Helmet",
		Category = "JMod - EZ Homicide",
		mdl = "models/eu_homicide/helmet.mdl", -- csgo
		slots = {
			head = 0.6,
			eyes = .4,
			mouthnose = .4
		...
		wgt = 15,
		dur = 200,
		ent = "ent_jack_gmod_ezarmor_plcriot",
	},
	["Heavy-Riot-Helmet"] = {
	...
	["Police-Vest"] = {
		PrintName = "[HMCD] Police-Vest",
		Category = "JMod - EZ Homicide",
		mdl = "models/eu_homicide/armor_on.mdl", -- gtaV
		slots = {
			chest = .6,
			abdomen = .4
		},
		...
		wgt = 10,
		dur = 450,
		ent = "ent_jack_gmod_ezarmor_plcvest",
		gayPhysics = false
	},
	["Medium-Vest"] = {
	...
	["Balistic-Vest"] = {
		PrintName = "[HMCD] Balistic-Vest",
		Category = "JMod - EZ Homicide",
		mdl = "models/combataegis/body/ballisticvest.mdl", -- dayz
		slots = {
			chest = .7,
			abdomen = .7
		},
		...
		wgt = 20,
		dur = 500,
		ent = "ent_jack_gmod_ezarmor_slickdayz",
		gayPhysics = true
	},
	["Level-IIIA"] = {
		PrintName = "[HMCD] Level IIIA Vest",
		Category = "JMod - EZ Homicide",
		mdl = "models/sal/acc/armor01.mdl", -- hmcd
		slots = {
			chest = 1,
			abdomen = .9
		},
		def = LightDMGMul,
		bon = "ValveBiped.Bip01_Spine2",
		siz = Vector(0.9, 0.9, 1),
		pos = Vector(-3, -49, 0),
		ang = Angle(-90, 0, 90),
		wgt = 60,
		dur = 300,
		ent = "ent_jack_gmod_ezarmor_lvl3a",
		gayPhysics = false
	},
	["Level-III"] = {
		PrintName = "[HMCD] Level III Vest",
		Category = "JMod - EZ Homicide",
		mdl = "models/sal/acc/armor01.mdl", -- hmcd
		clr = {
		    r = 80,
		...
		wgt = 70,
		dur = 200,
		ent = "ent_jack_gmod_ezarmor_lvl3",
		gayPhysics = false
	},
	["Medium-Heavy-Vest"] = {
