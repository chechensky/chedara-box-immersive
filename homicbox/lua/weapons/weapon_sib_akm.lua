...
if (CLIENT) then SWEP.WepSelectIcon=surface.GetTextureID("vgui/akm") SWEP.IconOverride="vgui/akm" end
------------------------------------------
...
SWEP.Primary.Sound = "weapons/tfa_ins2/akp/ak74/ak74_fp.wav"
...
SWEP.SightPos = Vector(-7,0.75,4.7)
SWEP.SightAng = Angle(-8,0,0)
